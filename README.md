...
**[Time Complexity Primer 🔗🔗](https://dev.to/ankushsinghgandhi/time-complexity-primer-understand-big-o-like-a-kid-with-candies-2ih0)**
...
### ⚡ Tier 2: Medium Priority (20–25% Weightage)
...
### 🧊 Tier 3: Optional (25-30% Weightage)
...
- Focus on problems from these lists after completing Tier 1 to Tier 3 topics for ₹10–15 LPA roles.
- Solidify your problem-solving skills with easy and medium difficulty questions before moving to advanced topics.

---

### 🧩 Tier 4: Advanced & Specialized Topics + Implementation Focus
...
- Minimum Spanning Tree algorithms (Kruskal’s with Union-Find, Prim’s)  
- Bellman-Ford algorithm for shortest paths with negative weights  
- Topological Sort (both DFS and Kahn’s algorithm)  
...
### 🎯 Practice Questions After Tier 4
